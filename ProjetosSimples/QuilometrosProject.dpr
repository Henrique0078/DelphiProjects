...
//Escreva um programa para converter velocidades de quilômetros por hora
...
begin
  try
    ...
    begin
      Writeln('Bem vindo!');
      Writeln('Voce deseja fazer a conversão de metro para quilometros, ou quilometros para metros?');
      Writeln('[0] Sair');
      ...
      if entrada = '1' then
        begin
          ...
          Readln(Input, a);
          b:= StrToFloat(a);
          Writeln(a + ' metros é equivalente a ' + mTokm(b) + ' quilometros!');
          Writeln('');
        end
      else
        if entrada = '2' then
          begin
            ...
            Readln(Input, a);
            b:= StrToFloat(a);
            Writeln(a + ' quilometro é equivalente a ' + kmTom(b) + ' metros!');
            Writeln('');
          end
          else
          if entrada = '0' then
